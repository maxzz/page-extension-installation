...
export function App3_Footer() {
    return (
        <div className="px-2 sm:px-4 py-2 text-sm flex items-center justify-between space-x-1 bg-title3 text-primary-400/75">
            <Link href="https://www.hidglobal.com/products/software/digitalpersona/digitalpersona" className="text-[.65rem] leading-3 md:text-xs transition-all">
